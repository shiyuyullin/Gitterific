            ...
            <table class="data-table">
                ...
                """),_display_(/*130.18*/for(repo <- repos) yield /*130.36*/{_display_(Seq[Any](format.raw/*130.37*/("""
                    """),format.raw/*131.21*/("""<tr>
                        ...
                        <td style="width: 20%"><a href="http://localhost:9000/repo/"""),_display_(/*133.85*/user/*133.89*/.getLogin),format.raw/*133.98*/("""/"""),_display_(/*133.100*/repo/*133.104*/.getName),format.raw/*133.112*/("""">"""),_display_(/*133.115*/repo/*133.119*/.getName),format.raw/*133.127*/("""</a></td>
