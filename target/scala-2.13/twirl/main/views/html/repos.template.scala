...
"""),format.raw/*6.1*/("""<html>
    ...
    <body>
        ...
        <a style="text-align: left; margin-left:10%" href="/issue/"""),_display_(/*120.68*/repo/*120.72*/.getAuthorName),format.raw/*120.86*/("""/"""),_display_(/*120.88*/repo/*120.92*/.getRepoName),format.raw/*120.104*/("""">Issues Page</a>
