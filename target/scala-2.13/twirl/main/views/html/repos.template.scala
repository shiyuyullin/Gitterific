...
"""),format.raw/*6.1*/("""<html>
    ...
    <body>
        ...
        <a style="text-align: left; margin-left:10%" href=""""),_display_(/*120.61*/routes/*120.67*/.HomeController.issue),format.raw/*120.88*/("""">Issues Page</a>
