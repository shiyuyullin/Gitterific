            ...
            <table class="data-table">
                ...
                """),_display_(/*136.18*/for(issue <- issues) yield /*136.38*/{_display_(Seq[Any](format.raw/*136.39*/("""
                    """),format.raw/*137.21*/("""<tr>
                        ...
                        <td style="width: 10%"><a href=""""),_display_(/*140.58*/routes/*140.64*/.HomeController.userProfile(issue.getIssue_name)),format.raw/*140.112*/("""">"""),_display_(/*140.115*/issue/*140.120*/.getIssue_name),format.raw/*140.134*/("""</a></td>
